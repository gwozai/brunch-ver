...
Defined in: [packages/oidc/src/get-vercel-oidc-token-sync.ts:24](https://github.com/gwozai/brunch-ver/blob/main/packages/oidc/src/get-vercel-oidc-token-sync.ts#L24)
