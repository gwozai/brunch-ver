...
Defined in: [packages/oidc/src/exchange-vercel-oidc-token.ts:138](https://github.com/gwozai/brunch-ver/blob/main/packages/oidc/src/exchange-vercel-oidc-token.ts#L138)
