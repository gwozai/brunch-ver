...
Defined in: [packages/oidc/src/verify-vercel-oidc-token.ts:53](https://github.com/gwozai/brunch-ver/blob/main/packages/oidc/src/verify-vercel-oidc-token.ts#L53)
