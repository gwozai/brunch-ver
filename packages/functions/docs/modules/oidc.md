...
[packages/functions/src/oidc/aws-credentials-provider.ts:70](https://github.com/gwozai/brunch-ver/blob/main/packages/functions/src/oidc/aws-credentials-provider.ts#L70)
