...
Defined in: [packages/functions/src/purge/types.ts:1](https://github.com/gwozai/brunch-ver/blob/main/packages/functions/src/purge/types.ts#L1)
...
Defined in: [packages/functions/src/purge/types.ts:6](https://github.com/gwozai/brunch-ver/blob/main/packages/functions/src/purge/types.ts#L6)
